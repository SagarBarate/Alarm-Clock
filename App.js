...
let initialHour =0, initialMinute =0, initialSec =0;
let alarmIndex =0;

//Append zeros for single digit that means if number is less than 10 it will append the 0 
...
setAlarm.addEventListener("click", () =>{
  ...
  let alarmObj =[];
  alarmObj.id=`${alarmIndex}_${hourInput.value}_${minuteInput.}`
})
